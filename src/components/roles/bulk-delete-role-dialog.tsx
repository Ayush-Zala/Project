...
interface BulkDeleteRoleDialogProps {
  open: boolean
...
export function BulkDeleteRoleDialog({ open, onOpenChange, roles, onSuccess }: BulkDeleteRoleDialogProps) {
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
             <p className="text-sm font-medium text-muted-foreground leading-relaxed">
                This action is permanent and cannot be reversed. Deleting the selected roles will immediately revoke access for all associated users.
             </p>
             {roles.some(r => r.slug === 'super-admin') && (
                <p className="text-[10px] font-bold text-red-500 uppercase tracking-widest bg-red-500/5 p-2 rounded border border-red-500/10">
                   Note: System roles (Super Admin) are protected and will be skipped.
                </p>
             )}
          </div>
