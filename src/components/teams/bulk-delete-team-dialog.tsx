...
export function BulkDeleteTeamDialog({ open, onOpenChange, teams, onSuccess }: BulkDeleteTeamDialogProps) {
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
             <p className="text-sm font-medium text-muted-foreground leading-relaxed">
                This action is permanent and cannot be reversed. Purging the selected teams will immediately dissociate all members and delete all historical mission data associated with these segments.
             </p>
          </div>
